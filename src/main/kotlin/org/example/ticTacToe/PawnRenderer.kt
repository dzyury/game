...
object PawnRenderer {
    ...
    fun showWhite(g2d: Graphics2D, width: Int, height: Int, isHint: Boolean) = show(g2d, zero, width, height, isHint)
    fun showBlack(g2d: Graphics2D, width: Int, height: Int, isHint: Boolean) = show(g2d, cross, width, height, isHint)
